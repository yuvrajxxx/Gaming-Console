...
int x = 25, y = 50;
const char* str = "No of Arrows:0";

// Function prototype for display_string
...
/* based on count display no of arrows and result of the game */
void counting()
{
    char buf[100];
    snprintf(buf, sizeof(buf), "No of Arrows:%d", count);
    display_string(40, 40, buf, 2);
    if (count1 == 1 && count2 == 1 && count3 == 1 && count4 == 1 && count5 == 1 && count6 == 1 && count7 == 1 && count8 == 1 && count9 == 1 && count10 == 1)
    {
        display_string(5, 300, "CONGRATULATIONS, YOU WON", 1);
...
void disa()
{
    ...
    else if ((x + 110 == 450) && (y >= 275 and y <= 305) && (!count6))
    {
        count6 = 1;
        x = 25;
        y = 0;
...
// Definition of display_string function
